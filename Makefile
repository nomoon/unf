...
COMMANDS=bin/unf bin/unf-test bin/unf-test-cf bin/unf-time
SRC=src/unf
...
bin/unf-test-cf: ${SRC}/unf-test-cf.cc ${SRC}/normalizer.hh ${SRC}/table.hh ${SRC}/util.hh ${SEARCH_TRIES}
	${CXX} ${CXX_FLAGS} -o ${@} ${<}
...
test: bin/unf-test bin/unf-test-cf
	bin/unf-test < data/normalization-test.txt
	bin/unf-test-cf < data/nfkc-casefold-test.txt
